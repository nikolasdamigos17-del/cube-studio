...
export const DICT = {
  ...
  'Select a client':'Επιλογή πελάτη','Add Record':'Προσθήκη Εγγραφής','Session Summary':'Σύνοψη Συνεδρίας','Weight':'Βάρος','Body Fat':'Σωματικό Λίπος','Muscle':'Μυς',
  ...
  'Add Manually':'Χειροκίνητη Προσθήκη',
  'Upload CSV File':'Ανέβασμα Αρχείου CSV',
  'Paste CSV Text':'Επικόλληση Κειμένου CSV','copy-paste the data':'αντιγραφή-επικόλληση','Parse Data':'Ανάλυση Δεδομένων',
  'Could not parse this file':'Αδυναμία ανάγνωσης αρχείου',
