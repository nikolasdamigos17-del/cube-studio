...
import MobileClientHome from '../components/MobileClientHome';
...
export default function ClientHome() {
  ...
  const [isMobileCH, setIsMobileCH] = useState(()=> typeof window!=='undefined' ? window.innerWidth<768 : false);
  useEffect(()=>{ const h=()=>setIsMobileCH(window.innerWidth<768); window.addEventListener('resize',h); return()=>window.removeEventListener('resize',h); },[]);
